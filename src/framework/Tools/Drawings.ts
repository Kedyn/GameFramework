...
export function drawLine(points: Array<{ x: number, y: number }>, options: DrawingOptions = DEFAULT_DRAW_OPTIONS): void {
...
export function drawCircle(x: number, y: number, options: DrawingCircleOptions = DEFAULT_DRAW_CIRCLE_OPTIONS): void {
    let context = SimpleGame.getCanvas().getContext("2d");
    context.save();
    context.setTransform(1, 0, 0, 1, 0, 0);    
    context.beginPath();
...
export function drawRect(x: number, y: number, width: number, height: number, options: DrawingOptions = DEFAULT_DRAW_OPTIONS): void {
    let context = SimpleGame.getCanvas().getContext("2d");
    context.save();
    context.setTransform(1, 0, 0, 1, 0, 0);
...
export function drawText(x: number, y: number, text: string, options: DrawingTextOptions = DEFAULT_DRAW_TEXT_OPTIONS): void {
    let context = SimpleGame.getCanvas().getContext("2d");
